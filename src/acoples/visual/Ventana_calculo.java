...
public class Ventana_calculo extends javax.swing.JInternalFrame {
    ...
    public Ventana_calculo(List list, String nombre_py) {
        this.datos = list;
        this.nombre = nombre_py;
        initComponents();
        setTitle(nombre);
        setBounds(0, 0, 1300, 930);
        //setBounds(0, 0, 1260, d.height-100);
        poblar_combo();
        py.setNombre_proyecto(nombre);
    ...
    public void poblar_combo() {
        ...
        for (int i = 0; i < datos.size(); i++) {
            ...
            jComboBox2.addItem(temp.get(0).toString());
        }
    }
...
//        System.out.println(varillas/separacion);
    ...
    private void initComponents() {
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos de ETABS", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
        ...
        jLabel115.setText("fyt [kgf/cm²] =");
        jPanel7.add(jLabel115);
        ...
        jLabel134.setText("ϕ flexión");
        jPanel7.add(jLabel134);
        ...
        jLabel140.setText("α propuesto [°] =");
        jPanel20.add(jLabel140);
        ...
        jPanel17.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Geometría de la diagonal", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14), new java.awt.Color(204, 0, 0))); // NOI18N
        ...
        jl9.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jl9FocusLost(evt);
            }
        });
        ...
        jLabel58.setText("1.1√f'c*Acw [tf] (18.10.7.2) =");
...
//        elementos.add(jt18.getText());
        ...
        if (ch.Dobles(elementos) == 1 || apellido_viga.getText() == null || apellido_viga.getText().equals("")) {
            ...
            String arr1[] = {jt1.getText(), jt2.getText(), jt3.getText(), jt4.getText(), jt5.getText(), jt6.getText(), jt7.getText(), jt8.getText(), jt9.getText(), jt10.getText(),
                ...
                jl1.getText(), jl2.getText(), jl3.getText(), jl4.getText(), jl5.getText(), jl6.getText(), jl7.getText(), jl8.getText(), jl9.getText(), jl10.getText(), jl11.getText(), jl12.getText(), apellido_viga.getText(), String.valueOf(db_equivalente_combo1), String.valueOf(db_equivalente_combo11)/*54*/, String.valueOf(estado_paneles_diag)/*55*/};//, String.valueOf((int) (35 / separacion_diag_base))/*56*/, String.valueOf((int) (35 / separacion_diag_caras))/*57*/ 
...
//            }
    ...
    private void aceptar_1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptar_1ActionPerformed
        if (banderin == false) {
            ...
            List temp1 = (List) datos.get(valor);
            jt3.setText(temp1.get(1).toString());
            jt2.setText(temp1.get(2).toString());
            jt1.setText(temp1.get(3).toString());
            jt7.setText(temp1.get(4).toString());
            jt10.setText(temp1.get(5).toString());
            jt23.setText(temp1.get(6).toString());
            //jt17.setText(String.valueOf(Double.parseDouble(jt4.getText()) + 2));
            //CALCULADOS
...
//            if (flag_contador == true) {
//                contador_viga++;
//                flag_contador = false;
//            }
            //apellido_viga.setText(String.valueOf(contador_viga));
            //contador_viga++; no debe ser aqui
...
//            }
            gama_colores_jt5();
            numero_viiga = jComboBox2.getSelectedIndex();
            flag = true;
            nombre_edit = "";
            jt7.requestFocus();
            banderin = true;
...
//            }
            ...
            for (int i = 0; i < py.getLista().size(); i++) {
                ...
                for (int j = 0; j < py.getLista().get(0).getPropiedades().length; j++) {
                    System.out.println(j + " = " + py.getLista().get(i).getPropiedades()[j]);
...
//        }
    ...
    private void combo1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_combo1FocusLost
        ...
        if (ch.Dobles(elementos) != 1) {
            ...
            separacion_diag_caras = (comodin_anti_error - db_equivalente_combo1) / (combo3.getSelectedIndex() + 1);
            if (separacion_diag_caras < Math.max(2 * db_combo3y5, db_combo3y5 + 2.5)) {
                ...
                System.out.println("separacion_diag_caras " + separacion_diag_caras);
                System.out.println("separacion_diag_caras < Math.max(2 * db_combo3y5, db_combo3y5 + 2.5) ");
                combo3.setBackground(Color.ORANGE);
                combo3.setSelectedIndex(0);
            } else {
                combo3.setBackground(UIManager.getColor(combo1));
...
//        }
    ...
    private void jl9FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jl9FocusLost
        // TODO add your handling code here:
    }//GEN-LAST:event_jl9FocusLost
